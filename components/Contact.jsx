          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 bg-white/5 hover:bg-white/10 rounded-2xl transition-colors border border-white/5 gap-6">
              ...
              <div className="flex gap-3 w-full md:w-auto justify-end">
                <a href="tel:+355686422652" className="w-12 h-12 bg-orange-500 hover:bg-orange-600 rounded-full flex items-center justify-center text-white text-xl transition-all shadow-lg hover:scale-110">
                  📞
                </a>
                <a href="https://wa.me/355686422652" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#25D366] hover:bg-[#20bd5a] rounded-full flex items-center justify-center text-white text-xl transition-all shadow-lg hover:scale-110">
                  💬
                </a>
              </div>
            </div>
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between p-6 bg-white/5 hover:bg-white/10 rounded-2xl transition-colors border border-white/5 gap-6">
              ...
              <div className="flex gap-3 w-full md:w-auto justify-end">
                <a href="tel:+447931124257" className="w-12 h-12 bg-orange-500 hover:bg-orange-600 rounded-full flex items-center justify-center text-white text-xl transition-all shadow-lg hover:scale-110">
                  📞
                </a>
                <a href="https://wa.me/447931124257" target="_blank" rel="noopener noreferrer" className="w-12 h-12 bg-[#25D366] hover:bg-[#20bd5a] rounded-full flex items-center justify-center text-white text-xl transition-all shadow-lg hover:scale-110">
                  💬
                </a>
              </div>
            </div>
